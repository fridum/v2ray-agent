...
menu() {
	cd "$HOME" || exit
	echoContent red "\n=============================================================="
	echoContent green "v2Ray-agent by mack-a [forked by: github.com/fridum] v2.6.10"
	echoContent green "Description: 8-in-1 coexistence script.\c"
	showInstallStatus
	echoContent red "\n=============================================================="
	echoContent green "ALL DONATIONS WILL SPEND FOR FREE INTERNET"
	echoContent green "FOR FREE INTERNET , FOR FREEDOM , FOR LIFE"
	echoContent green "0x41a5aA29C894a6F787F8aB22D2177cCE5D5F1031"
	echoContent green "bc1qhheuas6qkwgx8rkfv4t22flsw54ljdhye6v28j"
	echoContent red "=============================================================="
	if [[ -n "${coreInstallType}" ]]; then
		echoContent yellow "1.Reinstall"
	else
